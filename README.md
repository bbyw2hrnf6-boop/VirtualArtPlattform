...
- The post-story showcase presents Art exhibitions, Sculpture & 3D and Architecture independently from the three Studio templates. Showcase scene links remain unavailable until their own walkable publications exist; only Art exhibitions links to Studio, while Sculpture and Architecture are bespoke request work.
