...
1. Continue decomposing `src/App.tsx`, `src/features/gallery/GalleryScene.tsx` and `functions/src/index.ts` behind characterization tests; the Danny reference page and public-delivery Functions are already separated, and public/persistence contracts remain fixed.
