...
All three bespoke showcases offer guided visits. Obsidian and Sculpture open with skippable 26/28-second flights; Forest offers a 38-second flight through real entries and stairs. The homepage offers an opt-in 20-second video montage with original sound across all three worlds and persistent Explore links. Media loads only after Play, with 1080p/720p delivery and no homepage showcase WebGL contexts. Reduced motion uses free Walk and static chapters; changing the preference unloads the film. See [showcase direction](../src/features/showcase/README.md) for camera ownership, loading and qualification boundaries.
