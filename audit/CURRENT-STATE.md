...
The post-story homepage collection is a separate showcase surface for three next-level showroom concepts rather than another rendering of the Studio product or its templates. Each card has an optional future scene destination and honestly remains “Showcase coming soon” until its own walkable publication exists. The copy now distinguishes those future showcases from individually commissioned work available now, including recreating real galleries, rooms, homes or buildings from scans, photographs or plans. Art exhibitions also offers a clearly labelled route to the current Studio; Sculpture and Architecture remain bespoke request work. The bespoke banner is prepared, but its contact CTA remains visibly pending until the owner approves a monitored public email or enquiry URL. No reference screenshot, new image asset, template, GLB or publication identity is incorporated.
