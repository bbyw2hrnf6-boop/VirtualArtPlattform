...
describe("visitor keyboard contract", () => {
  it("uses E for look up and Q for look down, leaving R unbound", () => {
    ...
    expect(VISITOR_KEYBOARD_HINT).toContain("E/↑ look up");
    expect(VISITOR_KEYBOARD_HINT).toContain("Q/↓ look down");
