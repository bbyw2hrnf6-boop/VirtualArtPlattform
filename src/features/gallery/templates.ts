...
export const TEMPLATES: GalleryTemplate[] = [
  ...
  { id: 'pavilion', index: '03', name: 'The Grand Forum', label: 'Five Galleries · Skylit', description: 'A 40 × 60 metre museum plan with a grand central axis, four connected side galleries, a cross-gallery, and two architectural skylights.', dimensions: [40, 60], height: 5.6, maxArtworks: 14, dividerWidth: 14, accent: '#aa9372', camera: [0, 3.35, 28.2] }
];
