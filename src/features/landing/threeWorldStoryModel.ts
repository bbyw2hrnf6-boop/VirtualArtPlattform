...
export const WORLD_CHAPTERS = [
  ...
  {id:'forest-fold-house',name:'Forest Fold House',label:'Forest Fold House',heading:'Imagine it. Then walk inside.',copy:'From galleries and sculptural worlds to architecture you can enter. Individually authored, beyond the Studio.',start:13,end:20,cover:'/assets/showcases/forest-fold-house/cover.webp?v=5'},
] as const;
