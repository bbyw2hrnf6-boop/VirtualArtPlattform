...
const FAQS = [
  ...
  ['Can I publish without signing up?', 'Yes. Publish a public guest Space without a Creator profile. Request up to 7 days in Explore; placement starts only if approved. The direct link remains live during the 365-day hosting preview.'],
    ...
    <div className="aura-pitch">
      <section className="aura-pilot" aria-labelledby="aura-pilot-title">
        ...
        <div className="aura-pilot-options">
          <article>
            <span>Guest publishing · Explore request</span>
            <h3>Your work. Out in the world.</h3>
            <p>Publish without signup or a profile. Request a reviewed Explore placement for up to 7 days; the share link remains live during the hosting preview.</p>
