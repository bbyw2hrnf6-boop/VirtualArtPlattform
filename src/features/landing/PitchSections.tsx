...
const FAQS = [
  ['Do I need Blender or 3D software?', 'No. LIEUVA Studio creates each template Space in the browser. The Danny Hirsch reference demo uses a separate GLB asset, but a general Blender import pipeline is not part of the MVP yet.'],
  ...
  return (
    <div className="aura-pitch">
      ...
      <section className="aura-trust" aria-labelledby="aura-trust-title">
        ...
        <dl>
          <div><dt>Runtime</dt><dd>Procedural Three.js Spaces run in the browser. No Studio claim depends on a Blender pipeline.</dd></div>
