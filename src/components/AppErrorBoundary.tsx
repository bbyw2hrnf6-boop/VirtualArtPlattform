...
export class AppErrorBoundary extends Component<AppErrorBoundaryProps, AppErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    console.error('AURA could not render the current view.', error, info);
  }
  ...
  render() {
    ...
    return <main className="app-crash" role="alert" aria-labelledby="app-crash-title">
      <div>
        <p className="eyebrow">AURA · Recovery</p>
        <h1 id="app-crash-title">This view could not be opened.</h1>
        <p>Your gallery data has not been changed. Reload the page to try again, or return to the homepage.</p>
