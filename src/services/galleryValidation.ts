...
const WALL_FINISHES = ['chalk', 'warm', 'travertine', 'linen', 'charcoal'] as const satisfies readonly WallFinish[];
const FLOOR_FINISHES = ['concrete', 'oak', 'terrazzo', 'marble', 'black-marble', 'walnut', 'dark-oak'] as const satisfies readonly FloorFinish[];
