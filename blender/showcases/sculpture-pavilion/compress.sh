...
for tier in desktop mobile; do
  ...
  npm exec --yes --package=@gltf-transform/cli@4.5.0 -- gltf-transform meshopt "$ROOT/artifacts/sculpture/uncompressed/$asset" "$ROOT/public/assets/showcases/sculpture-pavilion/$asset"
done
