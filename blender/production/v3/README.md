...
- `*-r4-1280.png`, `*-r5-1280.png`: two complete rounds of native 1280 × 720 material/composition proofs.
...
- `render-manifest.json`: verified dimensions, bit depth, byte sizes and SHA-256 for all 18 finished PNGs.
...
See `../README.md`, `../../EXPORT_CONTRACT.md` and `../../../audit/LIEUVA-ARRIVAL-MATERIAL-STORY-2026-09-08.md` for reproduction, measurements and visual acceptance.
