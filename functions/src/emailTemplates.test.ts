...
const brand = {
  ...
  legalFooter: "AURA Studio · Example Street 1 · Amsterdam",
};

describe("AURA email templates", () => {
  it("renders a branded verification email with a fallback link", () => {
    ...
    expect(mail.subject).toContain("AURA");
  ...
  it("labels roadmap items as planned and includes unsubscribe", () => {
    ...
    expect(mail.html).toContain("AURA Studio · Example Street 1 · Amsterdam");
  });
